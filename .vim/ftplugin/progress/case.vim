...
" mz            -- make a mark named `z` at current cursor position
" <s-left>/b    -- move to beginning of word
" ve[Uu]        -- select word and make uppercase/lowercase
" `z            -- return to mark `z`
" a             -- append
inoremap <c-u> <c-o>mz<s-left><c-o>veU<c-o>`z
nnoremap <c-u>      mzbveU`z
inoremap <c-l> <c-o>mz<s-left><c-o>veu<c-o>`z
