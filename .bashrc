...
# ssh aliases
alias cccdata='ssh jwhite@cccdata'
alias ccdatesting='ssh jwhite@ccdatesting'
alias checkdev='ssh jwhite@checkdev'
alias chidev='ssh jwhite@chidev'
alias chiint='ssh jwhite@chiwebinternal'
alias chiprod2='ssh jwhite@chiprod2'
alias chiprod3='ssh jwhite@chiprod3'
alias fms001='ssh jwhite@fms001'
alias fms002='ssh jwhite@fms002'
alias fms003='ssh jwhite@fms003'
alias fms004='ssh jwhite@fms004'
alias fms005='ssh jwhite@fms005'
alias fmschar='ssh jwhite@fmschar'
alias fmscommon='ssh jwhite@fmscommon'
alias fmsportal='ssh jwhite@fmsportal'
alias fmstst='ssh jwhite@fmstst'
alias freecheck='ssh jwhite@freecheck'
alias freedev='ssh jwhite@freedev'
alias freefin='ssh jwhite@freefin'
alias freeops='ssh jwhite@freeops'
alias freewebdb='ssh jwhite@freewebdb'
alias haproxydev='ssh jwhite@haproxydev'
alias haproxy='ssh jwhite@haproxy'
alias latex='ssh jwhite@latex'
alias sophos='ssh jwhite@sophos'
alias tstportal='ssh jwhite@tstportal'
